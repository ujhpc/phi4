...
public:
  ...
  int partition(int i, int j) const { return partitions_[i*partition_size_ +j];}
...
public:
  ...
  static void init(int *dims_a) {
	...
	//	std::cerr<<"gp j "<<gp<<" "<<j<<" "<<grid_[gp*grid_size_+j]<<std::endl;
	++j;
	++grid;
      }      
      ++gp;
...
template<int Dim, typename IndexerType,typename Cell> int Block<Dim,IndexerType,Cell>::block_size_;
template<int Dim, typename IndexerType,typename Cell> int Block<Dim,IndexerType,Cell>::n_partitions_;
template<int Dim, typename IndexerType,typename Cell> int Block<Dim,IndexerType,Cell>::partition_size_;
template<int Dim, typename IndexerType,typename Cell> int Block<Dim,IndexerType,Cell>::dims_[Dim];
template<int Dim, typename IndexerType,typename Cell> int *Block<Dim,IndexerType,Cell>::partitions_;
template<int Dim, typename IndexerType,typename Cell> int Block<Dim,IndexerType,Cell>::n_grids_;
template<int Dim, typename IndexerType,typename Cell> int Block<Dim,IndexerType,Cell>::grid_size_;
template<int Dim, typename IndexerType,typename Cell> int *Block<Dim,IndexerType,Cell>::grid_;
template<int Dim, typename IndexerType,typename Cell> Cell Block<Dim,IndexerType,Cell>::cell_;
#endif
